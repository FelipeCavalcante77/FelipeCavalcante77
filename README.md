...
- 🔭 Atualmente estou trabalhando na Faculdade Fundação Dr Raul Bauab, no depart de TI (Programador)...
- 🔭 Trabalhei dois anos na rede de Supermercados JaúServe, no depart de TI (Manutenção de equipamentos de informatica)...
- 👨‍🎓 Formado no curso Técnico de Informática pela escola Etec Joaquim Ferreira do Amaral - Jaú ...
- 📘 Cursado o curso de Gestão da Técnologia da Informação na faculdade Fetec - Jaú ...
- 📘 Graduado de Desenvolvimento FullStack na Estácio ...
